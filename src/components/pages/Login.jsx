...
const Login = () => {
  return (
    <>
      <form className="h-fit w-fit flex flex-col justify-center items-center gap-8 rounded-md bg-gray-400 px-12 py-12">
        ...
        <div className="w-full h-fit text-xl text-red-500 font-bold flex justify-around items-center">
          <button className="h-fit w-fit p-2 rounded-full">
            <svg
