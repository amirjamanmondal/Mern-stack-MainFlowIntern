  ...
  return (
    <div className="h-fit px-12 py-4 w-full text-white flex flex-row gap-2">
      ...
      <ul className="w-1/2 h-full flex justify-between items-center">
        <li className="hover:bg-gray-500 p-2 rounded-md"><abbr title="Home" className="no-underline">Home</abbr> </li>
        <li className="hover:bg-gray-500 p-2 rounded-md"><abbr title="About" className="no-underline">About</abbr></li>
